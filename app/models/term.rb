...
class Term < ActiveRecord::Base
  attr_accessible :id,:program_id,:code,:name,:start_date,:end_date,:status,:created_at,:updated_at,:term_students_attributes,:term_courses_attributes,:advance_start_date,:advance_end_date
  belongs_to :program
