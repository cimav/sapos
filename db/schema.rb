...
ActiveRecord::Schema.define(:version => 20181002184405) do
  ...
  create_table "admission_exams", :force => true do |t|
    t.boolean  "make"
    t.boolean  "apply"
    t.boolean  "review"
    t.date     "exam_date"
  ...
  add_index "admission_exams", ["staff_id"], :name => "index_admission_exams_on_staff_id"
  ...
  create_table "exstudents", :force => true do |t|
    t.integer  "student_id"
    t.string   "phone"
    t.string   "cellphone"
    t.string   "email"
  ...
  add_index "exstudents", ["student_id"], :name => "index_exstudents_on_student_id"
  ...
  create_table "studies_plan_areas", :force => true do |t|
    t.integer  "studies_plan_id"
    t.string   "name"
    t.datetime "created_at",      :null => false
    t.datetime "updated_at",      :null => false
